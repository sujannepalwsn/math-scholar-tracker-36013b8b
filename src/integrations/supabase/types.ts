...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      trial_leads: {
        Row: {
          ...
          converted_to_center_id: string | null
          created_at: string
          email: string
        ...
        Relationships: [
          {
            foreignKeyName: "trial_leads_converted_to_center_id_fkey"
            columns: ["converted_to_center_id"]
            isOneToOne: false
            referencedRelation: "center_analytics_view"
            referencedColumns: ["id"]
          },
    ...
    Functions: {
      ...
      get_visitor_analytics: { Args: never; Returns: Json }
