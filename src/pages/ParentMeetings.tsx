...
import { CalendarDays, CheckCircle2, Clock, Eye, FileText, Info, MapPin, Users, Video, XCircle } from "lucide-react";
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                 ...
                 <p className="text-muted-foreground text-sm font-bold uppercase tracking-widest">Parent-Teacher Assembly & Coordination Nexus</p>
              </div>
            </div>
          </div>
        </div>
