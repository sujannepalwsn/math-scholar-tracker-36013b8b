...
import { Table, TableBody, TableCell, TableHeader, TableRow, TableHead, TableBody as TableBody_UI } from '@/components/ui/table';
import { BookOpen, FileText, User, GraduationCap, Calendar, Download, Info } from 'lucide-react';
