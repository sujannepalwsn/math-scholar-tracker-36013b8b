...
export const DEFAULT_NAV_ITEMS = [
  ...
  { name: "Students Registration", route: "/register", icon: "UserPlus", role: "teacher", feature_name: "students_registration", category: 'Administration', order: 11 },
  ...
  { name: "Leave Management", route: "/leave-management", icon: "Plane", role: "teacher", feature_name: "leave_management", category: 'Administration', order: 15 },
  ...
  { name: "My Attendance", route: "/teacher/my-attendance", icon: "Clock", role: "teacher", category: 'Academics', order: 9 },
  ...
  { name: "Messages", route: "/messages", icon: "MessageSquare", role: "teacher", feature_name: "messaging", category: 'Reports and Communication', order: 26 },
  { name: "Meetings", route: "/meetings", icon: "Video", role: "teacher", feature_name: "meetings_management", category: 'Reports and Communication', order: 27 },
  ...
  { name: "Lesson Tracking", route: "/parent-lesson-tracking", icon: "BookOpen", role: "parent", category: 'Academics', order: 1 },
  { name: "Exam Results", route: "/parent-results", icon: "GraduationCap", role: "parent", category: 'Academics', order: 2 },
  ...
  { name: "Student Report", route: "/parent-student-report", icon: "BarChart3", role: "parent", category: 'Reports and Communication', order: 9 },
  { name: "Calendar", route: "/parent-calendar", icon: "Calendar", role: "parent", category: 'Reports and Communication', order: 10 },
