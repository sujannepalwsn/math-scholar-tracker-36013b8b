...
export const DEFAULT_NAV_ITEMS = [
  ...
  { name: "Exams & Results", route: "/exams", icon: "GraduationCap", role: "center", feature_name: "exams_results", category: 'Academics', order: 7 },
  { name: "Published Results", route: "/published-results", icon: "Award", role: "center", feature_name: "published_results", category: 'Academics', order: 8 },
  { name: "Activities", route: "/activities", icon: "Paintbrush", role: "center", feature_name: "preschool_activities", category: 'Academics', order: 9 },
  ...
  { name: "Leave Management", route: "/leave-management", icon: "Plane", role: "center", feature_name: "leave_management", category: 'Administration', order: 15 },
  { name: "Student ID Cards", route: "/student-id-cards", icon: "IdCard", role: "center", feature_name: "student_id_cards", category: 'Administration', order: 16 },
  ...
  { name: "Messages", route: "/messages", icon: "MessageSquare", role: "center", feature_name: "messaging", category: 'Reports and Communication', order: 21 },
  { name: "Meetings", route: "/meetings", icon: "Video", role: "center", feature_name: "meetings_management", category: 'Reports and Communication', order: 22 },
  { name: "Calendar & Events", route: "/calendar", icon: "CalendarDays", role: "center", feature_name: "calendar_events", category: 'Reports and Communication', order: 23 },
  { name: "Student Report", route: "/student-report", icon: "User", role: "center", feature_name: "student_report", category: 'Reports and Communication', order: 24 },
  { name: "Attendance Summary", route: "/attendance-summary", icon: "Calendar", role: "center", feature_name: "attendance_summary", category: 'Reports and Communication', order: 25 },
  { name: "Summary", route: "/summary", icon: "BarChart3", role: "center", feature_name: "summary", category: 'Reports and Communication', order: 26 },
  { name: "Teacher Reports", route: "/teacher-performance", icon: "BarChart3", role: "center", feature_name: "teacher_reports", category: 'Reports and Communication', order: 27 },
