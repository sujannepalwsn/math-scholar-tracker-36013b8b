...
const navItems: Array<{
  ...
  { to: "/admin/landing-page", label: "Page Editor", icon: LayoutTemplate, role: 'admin' as const },
  { to: "/admin/demo-requests", label: "Sales Leads", icon: Users, role: 'admin' as const },
