...
export default function DashboardHeader() {
  ...
  return (
    <Card className="border-none shadow-glass overflow-hidden rounded-[2.5rem] md:rounded-[4rem] bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl mb-8 relative group/header border border-white/20">
      ...
      <CardContent
        className="py-2 px-5 md:p-8 relative z-10 space-y-2 md:space-y-8"
        style={{
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center gap-4 md:gap-6">
          ...
          <div className="flex flex-col md:flex-row items-center gap-2 md:gap-6 group/brand text-center">
                  ...
                  <div className="relative">
                    {isEditMode ? (
                      <Input
                        ...
                        className="text-lg md:text-2xl font-black h-auto py-1 px-3 bg-white/50 border-primary/20 rounded-xl text-center"
                        style={{
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2 md:gap-8 pt-2 md:pt-8 border-t border-black/5 dark:border-white/5">
