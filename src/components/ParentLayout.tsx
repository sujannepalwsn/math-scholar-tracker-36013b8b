...
import { AlertTriangle, BarChart3, Book, BookOpen, Calendar, ClipboardCheck, DollarSign, Home, KeyRound, LogOut, MessageSquare, Paintbrush, Settings, Star, User, Video } from "lucide-react";
...
const navItems: Array<{
  ...
  { to: "/parent-results", label: "Exam Results", icon: ClipboardCheck, role: 'parent' as const, category: 'Academics' },
