    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="fixed inset-x-4 top-20 sm:absolute sm:inset-auto sm:right-0 sm:top-14 sm:w-96 bg-card border rounded-2xl shadow-elevated z-[9999] overflow-hidden">
